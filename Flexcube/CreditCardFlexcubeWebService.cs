...
{
    public class CreditCardFlexcubeWebService
    {
        ...
        #region Constructors
        public CreditCardFlexcubeWebService(Config.WebServiceConfig parameters, IDataSource _dataSource)
        {
        ...
        public bool QueryCustAcc(string accountNumber, List<ProductPrinting.IProductPrintField> printFields, string branchCode, int languageId, out AccountDetails accDetails, out string responseMessage)
        {
            ...
            accDetails = null;
            Veneka.Module.OracleFlexcube.UBSAccWebService.CustAccountFullType custAcc = null;
            ...
            string customerNum = accountNumber;
            ...
            custAcc = new Module.OracleFlexcube.UBSAccWebService.CustAccountFullType();
            custAcc.ACC = accountNumber;
        ...
        private AccountDetails BuildAccountDetails(Veneka.Module.OracleFlexcube.UBSAccWebService.CustAccountFullType flexAccountDetails, List<ProductPrinting.IProductPrintField> printFields, Veneka.Module.OracleFlexcube.UBSCustWebService.CustomerFullType custDetails)
        {
            ...
            DecodeName(custDetails.FULLNAME, out firstName, out middlename, out lastname);
            ...
            AccountDetails rtn = new AccountDetails
            {
                ...
                Address1 = custDetails.ADDRLN1,
                Address2 = custDetails.ADDRLN2,
                Address3 = custDetails.ADDRLN3
